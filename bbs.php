<?php
  ...
  // データベースに接続する
  $dsn = 'mysql:dbname=LAA0808355-onelinebbs;host=mysql116.phy.lolipop.lan';
  $user = 'LAA0808355';
  $password = 'ness5210';
  ...
  if (!empty($_GET['action']) && $_GET['action'] == 'edit') {
    // ぱらめーたにactionがあり、かつactionの中身がeditだったら処理
            ...
            <article class="timeline-entry">
                <div class="timeline-entry-inner">
                  ...
                  <div class="timeline-label">
                    <h2>
                      <a href="#"><?php echo htmlspecialchars($post['nickname']); ?></a>
                      <span><?php echo $post['created'] ?></span>
                    </h2>
                    <p><?php echo htmlspecialchars($post['comment']) ?></p>
                    <a onclick="return confirm('本当に削除しますか？');" href="bbs.php?action=delete&id=<?php echo $post['id']; ?>">
